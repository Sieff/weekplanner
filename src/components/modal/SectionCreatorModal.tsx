...
export const SectionCreatorModal = ({onSubmit, onClose, startValues}: AppointmentCreatorProps) => {
    ...
    return (
        <Modal onClose={onClose} onSubmit={handleSubmit(processSubmit)} title={!!startValues ? "Abschnitt Bearbeiten" : "Neuer Abschnitt"} submitText={!!startValues ? "Speichern" : "Hinzufügen"}>
            <Form>
